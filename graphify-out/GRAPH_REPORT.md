...
## Corpus Check
- 127 files · ~94,845 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 348 nodes · 333 edges · 18 communities detected
...
Cohesion: 0.2
Nodes (8): add(), upload(), uploadFiles(), main(), parseBool(), parseCSV(), parseJsonArray(), slugify()

### Community 7 - "Community 7"
Cohesion: 0.15
Nodes (3): remove(), applyTheme(), setThemeExternal()
...
- **Why does `createClient()` connect `Community 2` to `Community 0`, `Community 6`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `GET()` connect `Community 0` to `Community 2`, `Community 5`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `add()` connect `Community 6` to `Community 4`, `Community 7`?**
